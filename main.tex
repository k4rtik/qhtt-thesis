...
\begin{mathpar}
    ...
    \quad\textsc{Axiom of Assignment}
\end{mathpar}
...
\begin{mathpar}
    ...
    {\{P\}\ c\ \{R\}}
    \quad\textsc{Weakening the post-condition}

    \inferrule
    {P \Rightarrow Q \\ \{Q\}\ c\ \{R\}}
    {\{P\}\ c\ \{R\}}
    \quad\textsc{Strengthening the pre-condition}
\end{mathpar}
...
\begin{mathpar}
    ...
    {\{P\}\ c\ \{Q\} \\ \{Q\}\ d\ \{R\}}
    {\{P\}\ c\ \textbf{;}\ d\ \{R\}}
    \quad\textsc{Rule of Composition}
\end{mathpar}
